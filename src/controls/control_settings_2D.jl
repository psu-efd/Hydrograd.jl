...
function parse_control_file(control_file::String)
    ...
    if settings.bVerbose
        ...
        if settings.bPerform_Inversion
            ...
            println("    optimizers = ", settings.inversion_settings.inversion_optimizers)
            println("    learning_rates = ", settings.inversion_settings.inversion_learning_rates)
            println("    max_iterations = ", settings.inversion_settings.inversion_max_iterations)
