...
def run_SRH_2D():
    ...
    my_srh_2d_model.open_project("simple.srhhydro")
...
def convert_SRH_2D_to_VTK():
    ...
    my_srh_2d_data = pyHMT2D.SRH_2D.SRH_2D_Data("simple.srhhydro")

    #read SRH-2D result in XMDF format (*.h5)
    #wether the XMDF result is nodal or cell center
    bNodal = False

    my_srh_2d_data.readSRHXMDFFile("simple_XMDFC.h5", bNodal)
