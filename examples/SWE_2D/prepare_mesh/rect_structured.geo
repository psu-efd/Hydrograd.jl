...
// Parameters
Lx = 4;    // Length of the rectangle along the x-axis
Ly = 3;    // Length of the rectangle along the y-axis
nx = 4;   // Number of divisions along x-axis for structured mesh
ny = 3;   // Number of divisions along y-axis for structured mesh
