...
def run_SRH_2D():
    ...
    my_srh_2d_model.open_project("twoD_channel_with_bump.srhhydro")
...
def convert_SRH_2D_to_VTK():
    ...
    my_srh_2d_data = pyHMT2D.SRH_2D.SRH_2D_Data("twoD_channel_with_bump.srhhydro")

    #read SRH-2D result in XMDF format (*.h5)
    #wether the XMDF result is nodal or cell center
    bNodal = False

    my_srh_2d_data.readSRHXMDFFile("twoD_channel_with_bump_XMDFC.h5", bNodal)
