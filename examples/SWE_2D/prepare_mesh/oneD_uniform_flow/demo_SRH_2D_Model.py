...
def run_SRH_2D():
    ...
    my_srh_2d_model.open_project("oneD_channel_uniform_flow_refined.srhhydro")
...
def convert_SRH_2D_to_VTK():
    ...
    my_srh_2d_data = pyHMT2D.SRH_2D.SRH_2D_Data("oneD_channel_uniform_flow_refined.srhhydro")

    #read SRH-2D result in XMDF format (*.h5)
    #wether the XMDF result is nodal or cell center
    bNodal = False

    my_srh_2d_data.readSRHXMDFFile("oneD_channel_uniform_flow_refined_XMDFC.h5", bNodal)
