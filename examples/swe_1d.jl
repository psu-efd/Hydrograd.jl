...
while fields.swe_1d_para.t < fields.swe_1d_para.tEnd
    ...
    swe_1D_rhs!(mesh::mesh_1D, fields::swe_1D_fields)

    # solve old values
    fields.h_old = fields.h
    fields.q_old = fields.q
    fields.dhdt_old = fields.dhdt
    fields.dqdt_old = fields.dqdt
    for i in 1:mesh.nCells
        fields.h[i] = fields.h[i] + fields.dhdt[i] * fields.swe_1d_para.dt
        fields.q[i] = fields.q[i] + fields.dqdt[i] * fields.swe_1d_para.dt
    end 
    ...
    for i in 1:mesh.nCells
        fields.h[i] = fields.h_old[i] + (fields.dhdt[i] + fields.dhdt_old[i]) * fields.swe_1d_para.dt / 2.0
        fields.q[i] = fields.q_old[i] + (fields.dqdt[i] + fields.dqdt_old[i]) * fields.swe_1d_para.dt / 2.0
    end 
