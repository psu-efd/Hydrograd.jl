...
# BCs: inletQ on the left and exitH on the right. Both inletQ and exitH are time varying 
# Bed profile: prescribed 
# ICs: prescribed 
# 
# Test the idea of UDE (Universal Differential Equation). Here, the Manning's n is a function of discharge Q. 
...
#load and process inletQ hydrograph data
load_hydrograph(save_path)
